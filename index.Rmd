...
### **NEW:** Comparing **keys** used in a selection Pink Floyd's **experimental and popular albums** using standard pitch class notation.
```{r, echo=FALSE}
floyd_keys <-
...
```{r, figures-side, fig.show="hold", out.width="50%", fig.align="top", echo=FALSE}
sevspec <-
